...
#include "fetch_teams/ledger/abstract_mutex.hpp"
#include "fetch_teams/ledger/vt100.hpp"
    ...
    namespace details {
      ...
      public:
        ...
        void Debug(Args &&... args)
        {
          ...
          if (this->log_ != nullptr)
          {
            this->log_->StartEntry(DefaultLogger::Level::DEBUG_, nullptr, TopContextImpl());
            Unroll<Args...>::Append(this, std::forward<Args>(args)...);
            this->log_->CloseEntry(DefaultLogger::Level::DEBUG_);
          }
        }
        ...
        void DEBUGWithName(char const *name, Args const &... args)
        {
          ...
          if (this->log_ != nullptr)
          {
            this->log_->StartEntry(DefaultLogger::Level::DEBUG_, name, TopContextImpl());
            Unroll<Args...>::Append(this, std::forward<Args>(args)...);
            this->log_->CloseEntry(DefaultLogger::Level::DEBUG_);
          }
        }
